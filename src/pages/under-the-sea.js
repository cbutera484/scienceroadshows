...
const UnderTheSeaPage = () => 
	<div>
		...
		<p>
      Looking for a great <strong>virtual</strong> or <strong>live</strong> show
      that’s fun and yet <u>covers your oceanography curriculum</u>? This is it!
      Whether it’s streamed or live, this show will delight your students and
      cover your NY State oceanography curriculum. For grades 2 - 6. It’s 45 min
      long.
			<strong>
		...
		<p>
      It’s presented by retired science teacher Lee Ognibene, former director of
      the Sayville Planetarium, videographer, and 1998 Suffolk County Science
      Teacher of the Year. Lee shot most of the video. You’ll see him in the
      video and hear his narration throughout the show.
			<TextImage src={fishImage} alt="Parrot" />
		</p>
		<p>
			<strong>UNDER THE SEA</strong> will transform your classroom, cafetorium,
      library, or multi-purpose room into an exciting oceanography show. It
      ...
      climate change, and species extinction. The show is only 45 minutes long,
      but you will be amazed how much your students will remember, even months
      after seeing this show!
		</p>
		<p>
			<strong>UNDER THE SEA</strong> is an inspiring show with incredible high
      definition video scenes, beautiful background music, and live commentary.
      ...
      vital to all life on Earth, even ours! It’s edutainment at its best!
		</p>
		<p>
      ...
      password and enjoy the show on your smartboard with your class. If you
      don’t have smart boards or laptop computers in every classroom, project
      the show on a screen in your classroom, cafetorium or media center with a
      video projector and stream it with a laptop computer using your schools’
      Wi-Fi.<br />
			<strong>
      ...
      at your school.{` `}
        ...
        “Exploratory Enrichment”. To find <u>Under the Sea</u>, search keyword
        the title or “oceanography” or search “Ognibene” to find all my shows.{` `}
			</strong>
		</p>
	</div>
